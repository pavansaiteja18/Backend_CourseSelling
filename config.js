...
const JWT_ADMIN_PASSWORD = "pavansaiteja"; // Access the JWT secret for admin authentication

// Retrieve the JWT user password from environment variables
const JWT_USER_PASSWORD = "pavansaiteja"; // Access the JWT secret for user authentication
